var routeDetails = {
  "C1 CCSU Connector": {
    ...
    "stops": ["Cedar Street", "East Street"],
    "Weekday AM Peak": "15",
    "Weekday Midday": "20",
    "Weekday PM Peak": "15",
    "Weekday Evening": "30",
  ...
  "C3 Newington Circulator": {
    ...
    "stops": ["Downtown New Britain", "Newington Junction", "Cedar Street"],
    "Weekday AM Peak": "30",
    "Weekday Midday": "60",
    "Weekday PM Peak": "30",
    "Weekday Evening": "60",
  ...
  "BX1 Waterbury Express": {
    ...
    "stops": ["Union Station", "Sigourney Street", "Downtown New Britain"],
  ...
  "BX2 Cheshire Express": {
    ...
    "stops": ["Downtown New Britain", "Sigourney Street", "Union Station"],
    "Weekday AM Peak": "30",
    "Weekday Midday": "",
    "Weekday PM Peak": "30",
    "Weekday Evening": "",
  ...
  "West Hartford Place via Park and Kane St": {
    ...
    "stops": ["Park Street", "Flatbush Avenue"],
  ...
  "Oak Street": {
    ...
    "stops": ["Downtown New Britain", "Cedar Street"],
  ...
  "Combined South and East Streets": {
    ...
    "stops": ["Downtown New Britain", "East Main Street"],
  ...
  "BW1 New Britain to Hartford Shuttle": {
    ...
    "stops": ["Downtown New Britain", "East Main Street", "East Street", "Cedar Street", "Newington Junction", "Elmwood", "Flatbush Avenue", "Kane Street", "Park Street", "Sigourney Street", "Union Station"],
  ...
  "BW3 New Britain-Westfarms-Hartford": {
    ...
    "stops": ["Downtown New Britain", "Elmwood", "Flatbush Avenue", "Kane Street", "Park Street", "Sigourney Street", "Union Station"],
  ...
  "BW4 UConn Health-Westfarms-Hartford": {
    ...
    "stops": ["Elmwood", "Flatbush Avenue", "Kane Street", "Park Street", "Sigourney Street", "Union Station"],
    "Service Span": "Seven days a week, 18 hours a day on Monday to Saturday (6am to Midnitght) and 12 hours (8am to 8pm) on Sundays.",
    "Weekday AM Peak": "18",
    "Weekday Midday": "20",
    "Weekday PM Peak": "18",
  ...
  "BW5 Newington Junction to Hartford Shuttle": {
    ...
    "stops": ["Newington Junction", "Elmwood", "Flatbush Avenue", "Kane Street", "Park Street", "Sigourney Street", "Union Station"],
    "Service Span": "This route will operate only on weekdays during AM and PM peak periods, from 6am to 9am and from 3pm to 6pm.",
    "Weekday AM Peak": "18",
    "Weekday Midday": "",
    "Weekday PM Peak": "18",
